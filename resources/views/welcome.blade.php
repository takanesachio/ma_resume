...
<head>
    ...
    <title>Laela Supriyatin | Resume</title>
...
<body class="relative custom_cursor">
    ...
    <div id="preloader">
        ...
        <div
            ...
            <img src="https://upload.wikimedia.org/wikipedia/commons/c/cc/LOGO-SWU-BERWARNA.png" alt="Minfo">
        </div>
    </div>
    ...
    <div class="relative pt-10 minfo__app max-xl:pt-20">
        ...
        <div class="max-lg:px-4">
                ...
                <div class="p-3 max-xl:mb-3 overflow-hidden minfo__sidebar bg-white dark:bg-nightBlack rounded-2xl">
                    ...
                    <div
                        ...
                        <ul class="space-y-3 *:flex *:text-sm">
                            ...
                            <li>
                                <span class="flex-1 font-medium text-black dark:text-white">Education:</span>
                                <span>STIMIK Widya Utama</span>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div
                ...
                <div
                    class="flex border rounded-full logo w-15 h-15 border-platinum dark:border-metalBlack flex-center hover:bg-white dark:hover:bg-metalBlack">
                    <a href="">
                        <img src="https://upload.wikimedia.org/wikipedia/commons/c/cc/LOGO-SWU-BERWARNA.png"
                            alt="Minfo">
                    </a>
            ...
            <div
                        ...
                        <div class="items-center gap-6 hero-content md:flex xl:gap-10">
                            <div class="text-content pt-7 lg:pt-8 max-lg:max-w-[30rem]">
                                ...
                                <ul
                                    ...
                                    <li>
                                        <i class="mr-2 fal fa-check-double text-theme"></i>
                                        Layanan Make-up Personal atau Profesional
                                    </li>
                                </ul>
                            </div>
                ...
                <div data-scroll-index="1" id="about">
                    ...
                    <div
                        class="about-section px-5 py-8 md:p-8 bg-white dark:bg-nightBlack rounded-2xl lg:p-10 2xl:p-13">
                        <div
                            class="inline-flex items-center gap-2 px-4 py-2 text-xs tracking-wide text-black dark:text-white border lg:px-5 section-name border-platinum dark:border-greyBlack200 rounded-4xl">
                        ...
                        <div class="mt-6 section-content">
                            <ul
                                ...
                                <li>
                                    <span class="flex-[0_0_6rem]">Telepon</span>
                                    <span class="flex-[0_0_2rem]">:</span>
                                    <span class="text-black dark:text-white">085641048848</span>
                                </li>
                                <li>
                                    <span class="flex-[0_0_6rem]">Email</span>
                                    <span class="flex-[0_0_2rem]">:</span>
                                    <span class="text-black dark:text-white">mahendralaela@gmail.com</span>
                                </li>
                                <li>
                                    <span class="flex-[0_0_6rem]">NIM</span>
                                    <span class="flex-[0_0_2rem]">:</span>
                                    <span class="text-black dark:text-white">SSI202303778</span>
                                </li>
                                <li>
                                ...
                                <li>
                                    <span class="flex-[0_0_6rem]">Bahasa</span>
                                    <span class="flex-[0_0_2rem]">:</span>
                                    <span class="text-black dark:text-white">Bahasa Indonesia, Inggris</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div data-scroll-index="4" id="resume">
                    ...
                    <div
                        class="resume-section px-5 py-8 md:p-8 bg-white dark:bg-nightBlack rounded-2xl lg:p-10 2xl:p-13">
                        <div
                            class="inline-flex items-center gap-2 px-4 py-2 text-xs tracking-wide text-black dark:text-white border lg:px-5 section-name border-platinum dark:border-greyBlack200 rounded-4xl">
                        ...
                        <div class="mb-8 mt-7 md:my-10 section-title">
                            <h2
                                class="title text-[32px] md:text-4xl lg:text-5xl font-extralight text-black dark:text-white leading-1.27">
                                Pengalaman <span class="font-semibold text-theme">Kerja</span>
                            </h2>
                            <p class="max-w-xl mt-4 md:mt-6 subtitle">
                                Saya bekerja sebagai Asisten Makeup Artist (MUA) yang berfokus pada keahlian dalam tata
                                rias dan perawatan wajah, membantu menciptakan tampilan yang diinginkan oleh klien.
                            </p>
                        </div><!--./section-title-->
                                ...
                                <li>
                                    ...
                                    <div
                                        ...
                                        <h4
                                            ...
                                            Asisten Makeup Artist
                                        </h4>
                                        <p>
                                            Saya bertanggung jawab membantu makeup artist dalam mempersiapkan klien
                                            dengan tata rias yang sesuai, memastikan hasil yang memuaskan sesuai
                                            permintaan klien.
                                        </p>
                                    </div>
                                </li>
                        ...
                        <div class="mb-8 mt-7 md:my-10 section-title">
                            <h2
                                class="title text-[32px] md:text-4xl lg:text-5xl font-extralight text-black dark:text-white leading-1.27">
                                Pendidikan <span class="font-semibold text-theme">Saya</span>
                            </h2>
                            <p class="max-w-xl mt-4 md:mt-6 subtitle">
                                Berikut adalah riwayat pendidikan saya yang telah membantu saya membangun keahlian di
                                bidang kecantikan dan tata rias.
                            </p>
                        </div>
                        ...
                        <div class="experience">
                            <ul
                                ...
                                <li>
                                    ...
                                    <div class="md:flex-1 md:pl-16 relative">
                                        <h4
                                            class="text-xl xl:text-2xl font-medium xl:font-medium leading-7 text-black dark:text-white mb-2.5">
                                            Kuliah S1 Sistem Informasi
                                        </h4>
                                        <p>
                                            Sedang menjalani studi di bidang Sistem Informasi untuk lebih memperdalam
                                            keahlian dalam pengolahan dan analisis informasi di dunia digital.
                                        </p>
                                    </div>
                                </li>
                            </ul>
                ...
                <div data-scroll-index="8" id="contact">
                    ...
                    <div
                        class="contact-section px-5 py-8 md:p-8 bg-white dark:bg-nightBlack rounded-2xl lg:p-10 2xl:p-13">
                        <div
                            class="inline-flex items-center gap-2 px-4 py-2 text-xs tracking-wide text-black dark:text-white border lg:px-5 section-name border-platinum dark:border-greyBlack200 rounded-4xl">
                        ...
                        <div class="grid gap-12 mt-8 mb-10 md:my-12 md:grid-cols-12">
                            <div class="md:col-span-5">
                                <ul
                                    class="contact-info space-y-6 md:space-y-10 2xl:space-y-12 *:flex *:flex-wrap *:items-center *:gap-5">
                                    <li>
                                        ...
                                        <div class="flex-1">
                                            <h6 class="text-lg text-black dark:text-white">Lokasi</h6>
                                            <p class="text-sm">Purwokerto, Indonesia</p>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="flex justify-center w-12 icon">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <p class="text-sm">mahendralaela@gmail.com</p>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="flex justify-center w-12 icon">
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <p class="text-sm">085641048848</p>
                                        </div>
                                    </li>
                                </ul>
                            </div>
